function initUsu(){
	if(window.addEventListener){
		window.addEventListener("load", Morazan, false);
	}
	else if(window.attachEvent){
		window.attachEvent("onload",Morazan,false);
	}
}
...
function Morazan(){
	Departamento = new Array('<p>Morazan</p>');
	Historia = new Array('<p class="text-justify">Morazán es un departamento de El Salvador ubicado en la zona oriental del país. Limita al Norte con la república de Honduras; al Sur y al Oeste con el departamento de San Miguel, y al Sur y al Este con el departamento de La Unión. Su cabecera departamental es San Francisco. Morazán comprende un territorio de 1 447 km² y cuenta con una población de 181 285 habitantes. </p>');
